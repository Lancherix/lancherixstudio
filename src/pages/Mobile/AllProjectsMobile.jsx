...
const AllProjectsMobile = () => {
    ...
    const StatusIcon = ({ status }) => {
        ...
        if (status === "pinned") {
            return (
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="size-7" className="statusIcon-projectsMobile">
        ...
        if (status === "archived") {
            return (
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="size-6" className="statusIcon-projectsMobile">
