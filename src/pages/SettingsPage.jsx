      ...
      <div className='allGeneral-settingsPage'>
        ...
        <div className='allGeneral-settingsPageOptions'>
          <div className='allGeneral-settingsPageOptionsSections'>
            <div className='allGeneral-settingsPageOptionsSectionsNoDiviso'><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="size-6">
          ...
          <div className='allGeneral-settingsPageOptionsSections'>
            ...
            </svg>{t('personalInformation')} Kiara</div>
            <div className='allGeneral-settingsPageOptionsSectionsNoDiviso'><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="size-6">
